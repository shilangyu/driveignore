...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.driveignore.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		// Search config in home directory with name ".driveignore" (without extension).
		viper.AddConfigPath(home)
		viper.SetConfigName(".driveignore")
	}
